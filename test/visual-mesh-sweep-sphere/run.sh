...
$DEBUG_PROGRAM test/visual-mesh-sweep-sphere "$MODEL" src/physics-3d/test/visual-mesh-sweep-sphere/sphere.glb src/physics-3d/test/visual-mesh-traceline/pointer.glb src/draw-3d/test/test.vert src/draw-3d/test/test.frag
